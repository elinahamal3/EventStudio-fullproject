...
<head>
  ...
  />
  <title>Our Packages | Event Studio</title>
</head>
<body>
  <!-- Header -->
  <header class="head">
  ...
  <section class="price" id="packages">
    <div class="packagess">
      ...
      <p>We offer flexible event packages designed to fit a range of needs and budgets.</p>
    </div>
    ...
    <div class="footer-grid">
      ...
      <div class="footer-col footer-quick-links">
        ...
        <ul>
          ...
          <li><a href="packages.php">Price</a></li>
